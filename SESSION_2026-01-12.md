...
### 1. Natural Conversation Teaching Style (MAJOR UX IMPROVEMENT)
**Based on user feedback during testing**

**Problem Identified:**
- Agent was drilling user: "Say привет!", "Repeat after me"
- Responses too long and verbose with markdown formatting
- Grammar explanations in Russian too confusing for beginners
- STT hardcoded to Russian, misinterpreting English

**Solution Implemented:**
Complete prompt rewrite focusing on natural conversation:

**Key Changes:**
- ❌ Remove drilling: "Say X word!"
- ✅ Natural conversations that organically use target vocabulary
- Example: "Привет! Как дела?" instead of "Now say hello"

**Flexible Response Length:**
- Short (5-15 words) for simple exchanges
- Longer (up to 50 words) OK for grammar explanations
- No more artificial 10-word limit

**Grammar Explanations:**
- ALWAYS in English for low-level learners
- Clear, practical (not academic)
- Example: "In Russian, adjectives come before nouns. You said X but it should be Y."

**Personality:**
- Clever and fun, not robotic
- Playful approach to make learning enjoyable
- Guides conversation to naturally require vocabulary goals

**Technical Fixes:**
- Removed markdown formatting (**, #, emojis)
- STT auto-detection (no longer hardcoded to Russian)
- Enhanced JSON parsing with better error logging

### 2. LingLangMemory Wrapper Class
...
### 1. Fatterbox Audio Peaking/Clipping
**Status:** Needs investigation
**Symptoms:** Popping/peaking sounds in TTS output
**Possible Causes:**
- Volume levels too high
- CUDA graphs optimization causing artifacts
- Speed parameter interaction with large model

**Investigation Plan:**
- Test with lower volume/speed settings
- Check Fatterbox Docker logs
- Test with different voice samples
- Consider disabling CUDA graphs if needed

### 2. Expressive TTS Tags
**Status:** Not implemented
**Question:** Should LLM generate expressive tags for Russian TTS?
**Current:** Plain text only
**Future:** Could add emotion/emphasis markers if Fatterbox supports them

### 3. Assistant Response Tracking
**Status:** Not implemented
...
### 1. Increased Context
- **10 → 15 turns**: 50% more context without code changes
...
- ⏳ 15+ turn conversation validation pending
- ⏳ Buffer expansion test pending
